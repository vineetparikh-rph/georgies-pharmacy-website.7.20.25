        ...
        <div className="flex animate-scroll-left-fast space-x-8">
          ...
          {testimonials.concat(testimonials).map((testimonial, index) => (
            <div
              ...
              className="flex-shrink-0 bg-white p-8 rounded-xl shadow-lg border border-slate-200 w-80 text-center"
            >
              ...
              <div className="flex justify-center mb-3">
                {Array.from({ length: 5 }, (_, i) => (
                  <span key={i} className="text-yellow-400 text-lg font-bold drop-shadow-sm">
                    ★
                  </span>
                ))}
              </div>
