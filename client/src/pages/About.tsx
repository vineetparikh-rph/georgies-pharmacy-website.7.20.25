      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-600 mb-8 max-w-3xl mx-auto">
            Better Care. Better Health. Your trusted healthcare partner for over
            15 years, committed to providing exceptional pharmaceutical care and
            personalized services to everyone in New Jersey.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-slate-600 mb-6">
                Founded in 2011, Georgies Pharmacy began as a small community
                pharmacy in Linden, New Jersey, originally known as St. Georges
                Family Pharmacy. With a simple mission—to provide personalized
                healthcare solutions with genuine care and attention to
                detail—we quickly became a trusted resource for local families.
              </p>
              <p className="text-lg text-slate-600 mb-6">
                Over the years, we've grown from a single storefront to four
                thriving locations, evolving into a comprehensive healthcare
                provider. Yet our core values remain unchanged: we believe every
                patient deserves individualized care, expert guidance, and
                convenient access to their medications.
              </p>
              <p className="text-lg text-slate-600">
                As we've expanded, we've stayed true to our roots. To honor our
                beginnings and continue the legacy that started on St. Georges
                Avenue, we proudly kept Georgies in the foundation of our name.
                Today, we serve thousands of patients across New Jersey while
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-slate-600">
                We maintain the highest standards in pharmaceutical care,
            ...
            <div className="text-center">
              ...
              <p className="text-slate-600">
                We're deeply committed to the health and wellness of our local
                community.
              </p>
            </div>
          </div>
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-200 text-center">
              ...
              <p className="text-slate-600 text-sm">
                Vineet Parikh is the CEO and Co-Founder of Georgies Pharmacy,
                which he launched alongside his father, Bharat Parikh, to
                reimagine local pharmacy care. With over 15 years of experience
                spanning entrepreneurship, operations, leadership, and direct
                patient care, Vineet brings both strategic vision and hands-on
                clinical expertise to every aspect of the business. Holding a
                doctorate in pharmacy, he is committed to delivering innovative,
                accessible healthcare solutions while preserving the
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-200 text-center">
              ...
              <p className="text-slate-600 text-sm">
                Specialized in pharmaceutical care and medication therapy
                management with 15+ years of experience in pharmacy operations.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-200 text-center">
              ...
              <p className="text-slate-600 text-sm">
                Specialized in medication synchronization programs and
                comprehensive pharmacy operations management.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-200 text-center">
              ...
              <p className="text-slate-600 text-sm">
                Specialized in clinical pharmacy services and specialty
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-200 text-center">
              ...
              <p className="text-slate-600 text-sm">
                Dedicated to providing exceptional patient care and medication
                therapy management.
              </p>
            </div>
          </div>
        ...
        <section className="text-center bg-gradient-to-r from-primary to-red-600 rounded-2xl p-12 text-white mb-16">
          ...
          <p className="text-xl text-red-100 max-w-4xl mx-auto">
            Better Care. Better Health. To provide exceptional pharmaceutical
            care through personalized service, innovative technology, and
            unwavering commitment to our patients' health and well-being. We
            strive to be the most trusted healthcare partner in our community.
          </p>
        </section>
      </main>
