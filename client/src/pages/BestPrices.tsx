      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <tbody>
                  {sampleResults.map((result, index) => (
                    ...
                    >
                      ...
                      <td
                        className={`p-4 font-bold ${index < 3 ? "text-green-600" : ""}`}
                      >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600 leading-relaxed">
                  Get up-to-date pricing from multiple sources including Mark
                  Cuban Cost Plus Drug pricing data.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600 leading-relaxed">
                  Compare prices across brand name, generic, and alternative
                  medications to find the best deal.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600 leading-relaxed">
                  See exactly how much you can save compared to other pharmacies
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600 leading-relaxed">
                  Prioritizes local pharmacy options while showing national
                  pricing benchmarks.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600 leading-relaxed">
                  Get pricing information in seconds, with options to transfer
                  or fill prescriptions immediately.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600 leading-relaxed">
                  Search anonymously without providing personal information or
                  insurance details.
                </p>
              </div>
            </div>
        ...
        <div className="bg-white rounded-xl p-10 mb-10 shadow-lg overflow-hidden">
          ...
          <div className="relative h-16 bg-slate-50 rounded-lg flex items-center overflow-hidden">
            ...
            >
              {[...popularMedications, ...popularMedications].map(
                (medication, index) => (
                  <div
                    key={index}
        ...
        <div className="bg-gradient-to-br from-primary to-red-900 text-white rounded-xl p-10 text-center shadow-lg">
          ...
          <p className="text-xl mb-8 opacity-90">
            Contact any of our locations for personalized pricing information
            and to discuss your prescription needs.
          </p>
