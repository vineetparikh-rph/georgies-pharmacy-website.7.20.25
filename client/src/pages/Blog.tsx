...
export default function Blog() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Georgies Pharmacy Blog - Health Tips & Medication Advice | NJ Pharmacy
        </title>
        <meta
          name="description"
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Expert health tips, medication advice, and pharmacy insights from
              our licensed pharmacists. Stay informed about the latest in
          ...
          <section className="mt-16 bg-gradient-to-r from-primary to-red-600 rounded-2xl p-12 text-white text-center">
            ...
            <p className="text-xl text-red-100 mb-8">
              Subscribe to our newsletter for the latest health tips, medication
              advice, and pharmacy updates.
            </p>
