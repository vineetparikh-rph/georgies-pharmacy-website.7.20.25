...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      {/* Modals */}
      <RefillModal open={refillModalOpen} onClose={() => setRefillModalOpen(false)} />
      ...
      <LocationsModal open={locationsModalOpen} onClose={() => setLocationsModalOpen(false)} />
      ...
      <footer className="bg-white border-t border-slate-200 mt-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="border-t border-slate-200 mt-8 pt-6 text-center">
            <p className="text-sm text-slate-600">
              &copy; 2024 GeorgiesRx. All rights reserved. Licensed Pharmacy.
            </p>
          </div>
        </div>
      </footer>
