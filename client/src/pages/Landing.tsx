...
export default function Landing() {
  ...
  const essentialTestimonials = [
    ...
    },
    {
      ...
      initials: "DJ",
      review:
        "Best pharmacy in the area! They go above and beyond to help their customers.",
      source: "via Facebook",
    },
    {
      id: "ML",
  ...
  useEffect(() => {
    const shuffleTestimonials = () => {
      const shuffled = [...essentialTestimonials].sort(
        () => Math.random() - 0.5,
      );
  ...
  return (
    <>
      <Helmet>
        <title>
          Georgies Pharmacy - #1 Rated Pharmacy | Linden, Parlin, Browns Mills
          NJ
        </title>
        <meta
          name="description"
            ...
            <div className="w-full max-w-7xl mx-auto">
              ...
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 mb-3 sm:mb-4 leading-tight px-2">
                <span className="sr-only">
                  Georgies Pharmacy - J.D. Power #1 Rated Pharmacy in New Jersey
                  serving Linden, Parlin, Browns Mills -{" "}
                </span>
                Better Care.{" "}
              ...
              <p className="text-base sm:text-lg text-slate-600 mb-6 sm:mb-8 max-w-2xl mx-auto leading-relaxed px-2">
                At Georgies Pharmacy, you become part of our family. We provide
                old-fashioned, personalized service combined with modern
                technology. Serving New Jersey since 2011.
              </p>
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-0 sm:py-2">
            ...
            <div className="flex justify-center mb-4 sm:mb-8">
              <div className="bg-white/95 backdrop-blur-sm rounded-lg p-6 shadow-lg border border-slate-200 max-w-md text-center">
                ...
                <p className="fluid-text-sm text-slate-600 mb-4">
                  Learn more about our family-owned pharmacy and our commitment
                  to personalized healthcare in your community.
                </p>
                <Button
          ...
          <section className="mb-8 sm:mb-16">
            <div className="text-center mb-6 sm:mb-12 adaptive-spacing">
              <h2 className="fluid-text-3xl font-bold text-slate-900 mb-4">
                Our Services
              </h2>
              <p className="fluid-text-lg text-slate-600 max-w-2xl mx-auto">
                Comprehensive healthcare services designed with your family's
                needs in mind
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
              ...
              <div className="bg-white/95 backdrop-blur-sm rounded-lg p-6 shadow-lg border border-slate-200 flex flex-col h-full min-h-[200px] hover:shadow-xl transition-shadow">
                ...
                <p className="fluid-text-sm text-slate-600 mb-6 flex-grow">
                  Request prescription refills online with just a few clicks.
              ...
              <div className="bg-white/95 backdrop-blur-sm rounded-lg p-6 shadow-lg border border-slate-200 flex flex-col h-full min-h-[200px] hover:shadow-xl transition-shadow">
                ...
                <p className="text-sm text-slate-600 mb-6 flex-grow">
                  Chat directly with our pharmacy team for questions,
              ...
              <div className="bg-white/95 backdrop-blur-sm rounded-lg p-6 shadow-lg border border-slate-200 flex flex-col h-full min-h-[200px] hover:shadow-xl transition-shadow">
                ...
                <p className="text-sm text-slate-600 mb-6 flex-grow">
                  FREE delivery and pickup options: Home Delivery, Curbside
              ...
              <div className="bg-white/95 backdrop-blur-sm rounded-lg p-6 shadow-lg border border-slate-200 flex flex-col h-full min-h-[200px] hover:shadow-xl transition-shadow">
                ...
                <p className="text-sm text-slate-600 mb-6 flex-grow">
                  Vaccines and clinical testing: Flu, MMR, Tdap, HepB, COVID
                  testing and more. WALK IN available
                </p>
                <Button
              ...
              <div className="bg-white/95 backdrop-blur-sm rounded-lg p-6 shadow-lg border border-slate-200 flex flex-col h-full min-h-[200px] hover:shadow-xl transition-shadow">
                ...
                <p className="text-sm text-slate-600 mb-6 flex-grow">
                  Wide selection of OTC medications, vitamins, and health
                  products with pickup or delivery options
                </p>
                <Button
          ...
          <section className="text-center bg-gradient-to-r from-primary to-red-900 rounded-2xl py-6 sm:py-8 px-4 sm:px-6 text-white mb-8 sm:mb-16">
            ...
            <p className="text-base text-red-100 mb-2">
              Track all your medications in one place. View status, refill
              counts, and prescription details. Your health information is
              protected with enterprise-grade security and HIPAA compliance.
              Join thousands of satisfied patients who trust Georgies Pharmacy
              ...
              <div className="text-center mb-8 sm:mb-12 lg:mb-16">
                <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-slate-900 mb-2 sm:mb-3 lg:mb-4 px-2">
                  <span className="block mb-1">
                    Ranked Highest by JD Power & Associates
                  </span>
