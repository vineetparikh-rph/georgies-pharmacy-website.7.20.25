  ...
  const essentialTestimonials = [
    {
      ...
      name: "Sarah M.",
      initials: "SM",
      review: "Amazing service! The staff is incredibly helpful and my prescriptions are always ready on time.",
      source: "via Facebook"
    },
    {
      id: "DJ",
    ...
    },
    {
      ...
      name: "Carol D.",
      initials: "CD",
      review: "Best prices in town! I compared with 5 other pharmacies and Georgies was significantly cheaper.",
      source: "via Google"
    }
  ];
                  ...
                  <div class="flex animate-scroll-left-fast space-x-8">
                    ${(() => {
                      const partners = [
                        ...
                        { name: "AmerisourceBergen", type: "Pharmaceutical Distribution", logo: "AB", category: "national" },
                        { name: "Cardinal Health", type: "Pharmaceutical Distribution", logo: "CH", category: "national" },
                        { name: "McKesson Corporation", type: "Pharmaceutical Distribution", logo: "MK", category: "national" },
                        { name: "Morris & Dickson", type: "Pharmaceutical Distribution", logo: "MD", category: "national" },
                        { name: "HD Smith", type: "Pharmaceutical Distribution", logo: "HDS", category: "national" },
                        
                        // Major PBM Partners
                        { name: "Express Scripts", type: "Pharmacy Benefits", logo: "ES", category: "technology" },
                        { name: "CVS Caremark", type: "Pharmacy Benefits", logo: "CVS", category: "technology" },
                        { name: "OptumRx", type: "Pharmacy Benefits", logo: "OPT", category: "technology" },
                        { name: "Humana Pharmacy", type: "Pharmacy Benefits", logo: "HUM", category: "technology" },
                        { name: "Prime Therapeutics", type: "Pharmacy Benefits", logo: "PT", category: "technology" },
                        
                        // Technology & Software Partners
                        { name: "Microsoft", type: "Technology Partner", logo: "MS", category: "technology" },
                        { name: "ComputerRx", type: "Pharmacy Software", logo: "CRx", category: "technology" },
                        { name: "Outcomes", type: "Healthcare Analytics", logo: "OUT", category: "technology" },
                        { name: "PDX", type: "Pharmacy Software", logo: "PDX", category: "technology" },
                        { name: "PharmaClik", type: "Pharmacy Management", logo: "PC", category: "technology" },
                        { name: "QS/1", type: "Pharmacy Software", logo: "QS1", category: "technology" },
                        { name: "PioneerRx", type: "Pharmacy Software", logo: "PRx", category: "technology" },
                        { name: "BestRx", type: "Pharmacy Software", logo: "BRx", category: "technology" },
                        { name: "Surescripts", type: "E-Prescribing Network", logo: "SS", category: "technology" },
                        { name: "RelayHealth", type: "Healthcare Connectivity", logo: "RH", category: "technology" },
                        
                        // Pharmacy Networks & Groups
                        { name: "Good Neighbor Pharmacy", type: "Pharmacy Network", logo: "GNP", category: "network" },
                        { name: "Health Mart", type: "Pharmacy Network", logo: "HM", category: "network" },
                        { name: "Independent Pharmacy Cooperative", type: "Pharmacy Network", logo: "IPC", category: "network" },
                        { name: "PSAO", type: "Pharmacy Services", logo: "PSAO", category: "network" },
                        { name: "RxOwnership", type: "Pharmacy Network", logo: "RxO", category: "network" },
                        { name: "Pharmacy Partners", type: "Pharmacy Network", logo: "PP", category: "network" },
                        
                        // Major NJ Hospital Systems
                        { name: "Hackensack Meridian", type: "Health Network", logo: "HMH", category: "local" },
                        { name: "RWJBarnabas Health", type: "Health System", logo: "RWJ", category: "local" },
                        { name: "AtlantiCare", type: "Health System", logo: "AC", category: "local" },
                        { name: "Cooper University", type: "Academic Medical", logo: "CUH", category: "local" },
                        { name: "Saint Peter's", type: "Healthcare Network", logo: "SPH", category: "local" },
                        { name: "Virtua Health", type: "Health System", logo: "VH", category: "local" },
                        { name: "Valley Health System", type: "Health Network", logo: "VHS", category: "local" },
                        { name: "Prime Healthcare", type: "Hospital Network", logo: "PHC", category: "local" },
                        
                        // Major Hospitals
                        { name: "Trinitas Medical Center", type: "Regional Hospital", logo: "TMC", category: "local" },
                        { name: "Englewood Hospital", type: "Community Hospital", logo: "EH", category: "local" },
                        { name: "Morristown Medical", type: "Academic Hospital", logo: "MM", category: "local" },
                        { name: "Overlook Medical", type: "Regional Hospital", logo: "OM", category: "local" },
                        { name: "Newark Beth Israel", type: "Teaching Hospital", logo: "NBI", category: "local" },
                        { name: "Jersey City Medical", type: "Regional Hospital", logo: "JCM", category: "local" },
                        { name: "Saint Barnabas", type: "Medical Center", logo: "SB", category: "local" },
                        { name: "Clara Maass", type: "Medical Center", logo: "CM", category: "local" },
                        { name: "Chilton Medical", type: "Community Hospital", logo: "CMC", category: "local" },
                        { name: "Holy Name Medical", type: "Regional Hospital", logo: "HNM", category: "local" },
                        { name: "CentraState Medical", type: "Healthcare System", logo: "CS", category: "local" },
                        { name: "Monmouth Medical", type: "Regional Hospital", logo: "MMC", category: "local" },
                        { name: "Ocean Medical Center", type: "Regional Hospital", logo: "OMC", category: "local" },
                        { name: "Riverview Medical", type: "Regional Hospital", logo: "RMC", category: "local" },
                        { name: "Capital Health", type: "Health System", logo: "CH", category: "local" },
                        { name: "Hunterdon Medical", type: "Regional Hospital", logo: "HMC", category: "local" },
                        { name: "Somerset Medical", type: "Regional Hospital", logo: "SMC", category: "local" },
                        { name: "JFK Medical Center", type: "Regional Hospital", logo: "JFK", category: "local" },
                        { name: "University Hospital", type: "Academic Medical", logo: "UH", category: "local" },
                        
                        // Specialty Hospitals
                        { name: "Deborah Heart & Lung", type: "Specialty Hospital", logo: "DHL", category: "local" },
                        { name: "Children's Specialized", type: "Pediatric Hospital", logo: "CSH", category: "local" },
                        { name: "Goryeb Children's", type: "Pediatric Hospital", logo: "GCH", category: "local" },
                        { name: "Institute for Neurology", type: "Specialty Hospital", logo: "IFN", category: "local" },
                        { name: "Cancer Institute of NJ", type: "Cancer Center", logo: "CINJ", category: "local" },
                        { name: "Eye Institute of NJ", type: "Specialty Center", logo: "EINJ", category: "local" },
                        
                        // Urgent Care Networks
                        { name: "CarePoint Health", type: "Urgent Care Network", logo: "CPH", category: "local" },
                        { name: "Patient First", type: "Urgent Care", logo: "PF", category: "local" },
                        { name: "MedExpress", type: "Urgent Care", logo: "ME", category: "local" },
                        { name: "ConvenientCare", type: "Urgent Care", logo: "CC", category: "local" },
                        { name: "FastCare", type: "Urgent Care", logo: "FC", category: "local" },
                        { name: "AFC Urgent Care", type: "Urgent Care", logo: "AFC", category: "local" },
                        { name: "GoHealth Urgent Care", type: "Urgent Care", logo: "GH", category: "local" },
                        
                        // Military & VA Medical
                        { name: "Joint Base MDL", type: "Military Medical", logo: "MDL", category: "local" },
                        { name: "McGuire Air Force Base", type: "Military Medical", logo: "MAFB", category: "local" },
                        { name: "Fort Dix Medical", type: "Military Medical", logo: "FDM", category: "local" },
                        { name: "Lakehurst Naval Medical", type: "Military Medical", logo: "LNM", category: "local" },
                        { name: "VA Medical Center East Orange", type: "Veterans Hospital", logo: "VAEO", category: "local" },
                        { name: "VA Medical Center Lyons", type: "Veterans Hospital", logo: "VAL", category: "local" },
                        { name: "VA Outpatient Clinic", type: "Veterans Care", logo: "VAOC", category: "local" },
                        
                        // Medical Groups & Practices
                        { name: "CareStation Medical", type: "Medical Group", logo: "CSM", category: "local" },
                        { name: "Summit Medical Group", type: "Medical Practice", logo: "SMG", category: "local" },
                        { name: "Allied Physicians", type: "Medical Group", logo: "AP", category: "local" },
                        { name: "Garden State Medical", type: "Medical Group", logo: "GSM", category: "local" },
                        { name: "Princeton Medical", type: "Medical Group", logo: "PM", category: "local" },
                        { name: "Shore Medical Group", type: "Medical Practice", logo: "SHM", category: "local" },
                        
                        // Insurance Partners
                        { name: "Aetna", type: "Health Insurance", logo: "AET", category: "insurance" },
                        { name: "Blue Cross Blue Shield", type: "Health Insurance", logo: "BCBS", category: "insurance" },
                        { name: "Cigna", type: "Health Insurance", logo: "CIG", category: "insurance" },
                        { name: "UnitedHealthcare", type: "Health Insurance", logo: "UHC", category: "insurance" },
                        { name: "Horizon BCBSNJ", type: "Health Insurance", logo: "HOR", category: "insurance" },
                        { name: "AmeriHealth", type: "Health Insurance", logo: "AMH", category: "insurance" },
                        { name: "Medicaid NJ", type: "State Insurance", logo: "MNJ", category: "insurance" },
                        { name: "Medicare", type: "Federal Insurance", logo: "MED", category: "insurance" },
                        
                        // Payment Partners
                        { name: "Visa", type: "Payment Processing", logo: "V", category: "payment" },
                        { name: "Mastercard", type: "Payment Processing", logo: "MC", category: "payment" },
                        { name: "American Express", type: "Payment Processing", logo: "AE", category: "payment" },
                        { name: "Discover", type: "Payment Processing", logo: "D", category: "payment" },
                        { name: "PayPal", type: "Digital Payments", logo: "PP", category: "payment" },
                        { name: "Amboy Bank", type: "Local Banking", logo: "AB", category: "payment" },
                        
                        // Specialty Partners
                        { name: "FDB", type: "Drug Database", logo: "FDB", category: "specialty" },
                        { name: "Lexicomp", type: "Clinical Decision", logo: "LEX", category: "specialty" },
                        { name: "Medi-Span", type: "Drug Information", logo: "MS", category: "specialty" },
                        { name: "ScriptPro", type: "Automation Systems", logo: "SP", category: "specialty" },
                        { name: "Parata Systems", type: "Packaging Solutions", logo: "PS", category: "specialty" },
                        { name: "Innovation", type: "Packaging Systems", logo: "INN", category: "specialty" }
                      ];
                      ...
                      <div class="flex-shrink-0 bg-white p-6 rounded-xl shadow-lg border border-slate-200 w-64 text-center hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                        <div class="w-16 h-16 rounded-full flex items-center justify-center text-white font-bold text-xs mx-auto mb-4 shadow-lg ${
                          partner.category === 'payment' ? 'bg-gradient-to-br from-green-600 to-green-800' :
                          partner.category === 'technology' ? 'bg-gradient-to-br from-blue-600 to-blue-800' :
                          partner.category === 'local' ? 'bg-gradient-to-br from-purple-600 to-purple-800' :
                          partner.category === 'network' ? 'bg-gradient-to-br from-orange-600 to-orange-800' :
                          partner.category === 'insurance' ? 'bg-gradient-to-br from-teal-600 to-teal-800' :
                          partner.category === 'specialty' ? 'bg-gradient-to-br from-indigo-600 to-indigo-800' :
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="JD Power & Associates #1 Rated Pharmacy 8 years running! Georgies Pharmacy serves Linden, Parlin & Browns Mills NJ with prescription refills, transfers, vaccinations & personalized family care since 2011." />
        <meta name="keywords" content="pharmacy near me, prescription refills, Linden pharmacy, Parlin pharmacy, Browns Mills pharmacy, JD Power & Associates pharmacy, prescription transfer, vaccinations, family pharmacy, New Jersey pharmacy, Georgies Pharmacy" />
        
        {/* Open Graph */}
        <meta property="og:title" content="Georgies Pharmacy - #1 Rated Pharmacy | Linden, Parlin, Browns Mills NJ" />
        <meta property="og:description" content="JD Power & Associates #1 Rated Pharmacy 8 years running! Family pharmacy serving New Jersey with prescription refills, transfers, vaccinations & personalized care since 2011." />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "description": "JD Power & Associates #1 Rated Pharmacy serving New Jersey with prescription services, refills, transfers, and personalized family care since 2011.",
        ...
        <div className="relative z-20 flex items-center justify-center h-full py-2 sm:py-8 px-4 sm:px-6 lg:px-8 text-center">
          <div className="w-full max-w-7xl mx-auto">
            ...
            <p className="text-base sm:text-lg text-slate-600 mb-6 sm:mb-8 max-w-2xl mx-auto leading-relaxed px-2">
              At Georgies Pharmacy, you become part of our family. We provide old-fashioned, personalized service combined with modern technology. Serving New Jersey since 2011.
            </p>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-0 sm:py-2">
        ...
        <section className="text-center bg-gradient-to-r from-primary to-red-900 rounded-2xl py-6 sm:py-8 px-4 sm:px-6 text-white mb-8 sm:mb-16">
          <h2 className="fluid-text-4xl font-bold mb-2">
            Access Prescription Management 24/7
          </h2>
          <p className="text-base text-red-100 mb-2">
            Track all your medications in one place. View status, refill counts, and prescription details. Your health information is protected with enterprise-grade security and HIPAA compliance. Join thousands of satisfied patients who trust Georgies Pharmacy for their healthcare needs.
          </p>
              ...
              <div className="flex flex-wrap justify-center items-center gap-4 sm:gap-6 lg:gap-8 mb-6 sm:mb-8">
                <div className="bg-white p-4 sm:p-6 rounded-xl shadow-lg border border-slate-200 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                  <div className="flex flex-col items-center">
                    ...
                    <h3 className="font-semibold text-slate-900 text-xs sm:text-sm">JD Power & Associates</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="border-t border-slate-800 mt-8 pt-6 text-center">
            <div className="space-y-3">
              ...
              <p className="text-slate-300">&copy; 2025 by Georgies Pharmacy Group. All rights reserved. Licensed Pharmacy.</p>
            </div>
          </div>
        </div>
      </footer>
