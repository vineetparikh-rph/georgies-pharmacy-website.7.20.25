...
export default function Locations() {
  ...
  React.useEffect(() => {
    document.title =
      "Pharmacy Locations | Georgies Pharmacy - Linden, Parlin, Browns Mills NJ";
  }, []);
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12">
        ...
        <div className="text-center mb-8 sm:mb-10 lg:mb-12 bg-gradient-to-r from-primary to-red-900 rounded-2xl p-6 sm:p-8 lg:p-12 text-white">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6 sm:mb-8 max-w-4xl mx-auto">
            {[
              ...
              >
                ...
                />
                <span
                  className={`text-sm sm:text-base font-medium ${selectedAction === action.value ? "text-white" : "text-white/90"}`}
                >
                  {action.label}
                </span>
              </label>
          ...
          <div className="max-w-md mx-auto">
            ...
            >
              ...
              <option value="family" className="text-slate-900">
                Georgies Family Pharmacy - Linden
              </option>
              <option value="specialty" className="text-slate-900">
                Georgies Specialty Pharmacy - Linden
              </option>
              <option value="parlin" className="text-slate-900">
                Georgies Parlin Pharmacy - Parlin
              </option>
              <option value="outpatient" className="text-slate-900">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 mb-8 sm:mb-12">
          {locations.map((location, index) => (
            <Card
              key={index}
              className="bg-white shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border-0"
            >
                      ...
                      <tbody>
                        {location.hours.map((hour, idx) => (
                          <tr
                            key={idx}
                            className={
                              idx !== location.hours.length - 1
                                ? "border-b border-slate-200"
                                : ""
                            }
                          >
                            <td className="p-2 sm:p-3 text-xs sm:text-sm font-medium text-slate-700">
                              {hour.day}
                            </td>
                            <td className="p-2 sm:p-3 text-xs sm:text-sm text-slate-600">
                              {hour.time}
                            </td>
                          </tr>
                        ))}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 max-w-4xl mx-auto">
              {[
                ...
                >
                  ...
                  />
                  <span
                    className={`text-sm sm:text-base font-medium ${selectedAction === option.value ? "text-primary" : "text-slate-700"}`}
                  >
                    {option.label}
                  </span>
                </label>
