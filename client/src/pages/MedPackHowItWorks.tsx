      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-xl p-10 mb-8 shadow-lg border-l-6 border-primary">
          ...
          <p className="text-lg text-slate-600 mb-5 leading-relaxed">
            First, we'll work with you to transfer all your current prescriptions to Georgies
            Outpatient Pharmacy. This process is completely free and we handle all the coordination
            with your current pharmacy and doctors.
          </p>
        ...
        <div className="bg-white rounded-xl p-10 mb-8 shadow-lg border-l-6 border-primary">
          ...
          <p className="text-lg text-slate-600 mb-5 leading-relaxed">
            Our pharmacists carefully organize all your medications into individual dose packets.
            Each packet is clearly labeled with the date, time, and contains exactly the medications
            you need for that specific dose.
          </p>
        ...
        <div className="bg-white rounded-xl p-10 mb-8 shadow-lg border-l-6 border-primary">
          ...
          <p className="text-lg text-slate-600 mb-5 leading-relaxed">
            Your medications are delivered directly to your home every month, completely free of
            charge. No more trips to the pharmacy or worrying about running out of medications.
          </p>
        ...
        <div className="bg-white rounded-xl p-10 mb-8 shadow-lg border-l-6 border-primary">
          ...
          <p className="text-lg text-slate-600 mb-5 leading-relaxed">
            We don't just deliver your medications - we actively manage your prescriptions, work
            with your doctors for refills, and provide ongoing pharmacist support whenever you need
            it.
          </p>
        ...
        <div className="bg-gradient-to-br from-primary to-red-900 text-white rounded-xl p-10 text-center shadow-lg mb-8">
          ...
          <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
            Call Georgies Outpatient Pharmacy today to begin your MedPack service. Our team will
