...
export default function OTCStore() {
  ...
  useEffect(() => {
    document.title =
      "OTC Online Store | Georgies Pharmacy | Over-the-Counter Medications NJ";
  }, []);
      ...
      <section className="bg-primary text-white p-6">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-3xl font-bold mb-2">
            Georgies Pharmacy – OTC Online Store
          </h1>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-bold mb-4">
              Why Shop OTC with Georgies Pharmacy?
            </h2>
