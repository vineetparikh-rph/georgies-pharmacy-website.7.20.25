        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            <div>
              ...
              <p className="text-xl text-slate-600 mb-8">
                Professional clinical pharmacy services in Browns Mills, NJ, specializing in
                outpatient care, post-surgical medications, and comprehensive pharmaceutical support
                for medical treatments. We bridge the gap between hospital and home care.
              </p>
          ...
          <section className="mb-16">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="prose prose-lg max-w-none text-slate-700 space-y-6">
                <p>
                  Georgies Outpatient Pharmacy in Browns Mills represents our commitment to
                  providing hospital-quality pharmaceutical care in an outpatient setting. Since
                  joining the Georgies family, we've specialized in serving patients who require
                  clinical-level support for their medication needs, particularly those
                  transitioning from hospital to home care.
                </p>
                <p>
                  Our Browns Mills location is uniquely positioned to serve patients requiring
                  post-surgical medications, complex discharge prescriptions, pain management
                  solutions, and specialized medical supplies. We work closely with local hospitals,
                  surgery centers, and healthcare providers to ensure seamless care transitions and
                  optimal patient outcomes.
                </p>
                <p>
                  What makes our outpatient pharmacy special is our clinical approach to
                  pharmaceutical care. Our team includes pharmacists with extensive experience in
                  institutional settings who understand the complexities of post-acute care. We
                  provide comprehensive medication reviews, drug interaction screenings, and
                  detailed patient education to ensure safe and effective medication management at
                  home.
                </p>
                <p>
                  We're particularly proud of our free prescription delivery service throughout
                  Browns Mills and surrounding areas, recognizing that many of our patients may have
                  mobility limitations or transportation challenges following medical procedures.
                  Our commitment extends beyond medication dispensing to include ongoing clinical
                  support, insurance coordination, and collaboration with your entire healthcare
          ...
          <section className="text-center bg-gradient-to-r from-purple-600 to-teal-600 rounded-2xl p-12 text-white">
            ...
            <p className="text-xl text-purple-100 mb-8">
              Experience hospital-quality pharmaceutical care for your outpatient needs. Free
              delivery available in Browns Mills.
            </p>
