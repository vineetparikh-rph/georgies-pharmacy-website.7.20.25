        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            <div>
              ...
              <p className="text-xl text-slate-600 mb-8">
                Your convenient neighborhood pharmacy in Parlin, serving the local community with
                personalized care, drive-through service, and extended hours. We're committed to
                making your healthcare experience as convenient and comfortable as possible.
              </p>
          ...
          <section className="mb-16">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="prose prose-lg max-w-none text-slate-700 space-y-6">
                <p>
                  Georgies Parlin Pharmacy has been a trusted healthcare partner for families in
                  Parlin, Sayreville, and surrounding communities since joining the Georgies family.
                  Located conveniently on Ernston Road, our pharmacy combines the warmth and
                  personal attention of a neighborhood pharmacy with modern conveniences that fit
                  your busy lifestyle.
                </p>
                <p>
                  What makes our Parlin location special is our commitment to convenience without
                  compromising on care. Our drive-through service allows you to pick up
                  prescriptions quickly and safely, while our extended hours ensure we're available
                  when you need us most. Whether you're rushing to work, managing family schedules,
                  or simply prefer the convenience of staying in your car, we've designed our
                  services around your needs.
                </p>
                <p>
                  Our experienced pharmacy team takes pride in knowing each customer personally and
                  understanding their unique health requirements. We work closely with local
                  healthcare providers to ensure seamless care coordination and offer comprehensive
                  services including immunizations, diabetes management supplies, blood pressure
                  monitoring, and detailed medication consultations.
                </p>
                <p>
                  As part of the Georgies Pharmacy Group, we maintain the highest standards of
                  pharmaceutical care while fostering the close-knit community relationships that
                  make neighborhood pharmacies special. We're not just your pharmacy – we're your
                  neighbors, committed to supporting the health and wellness of everyone we serve in
                  Parlin and beyond.
                </p>
              </div>
            </div>
          ...
          <section className="text-center bg-gradient-to-r from-green-600 to-blue-600 rounded-2xl p-12 text-white">
            ...
            <p className="text-xl text-green-100 mb-8">
              Visit our Parlin location for fast, friendly service and comprehensive pharmaceutical
              care.
            </p>
