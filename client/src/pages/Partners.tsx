...
export default function Partners() {
  ...
  const localPartners = [
    ...
    },
    {
      ...
      type: "Health System",
      description: "New Jersey's largest integrated healthcare delivery system serving communities statewide.",
      category: "Health System",
    ...
    },
    {
      name: "AtlantiCare",
      type: "Health System", 
      description: "Regional health system providing comprehensive care throughout southern New Jersey.",
      category: "Health System",
    ...
    },
    {
      ...
      description: "Academic health system with Level I trauma center and medical school affiliation.",
    ...
    },
    {
      ...
      type: "Community Hospital",
      description: "Community hospital providing comprehensive healthcare services to Essex County.",
      category: "Hospital",
    ...
    },
    {
      ...
      description: "Air Force medical facility providing healthcare to military personnel and families.",
      category: "Military",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-green-50">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-slate-900 mb-4">Payment and Financial Partners</h2>
            <p className="text-lg text-slate-600 max-w-3xl mx-auto">
              We accept all major credit cards and work with leading financial partners to make healthcare accessible and convenient.
            </p>
          </div>
          
          {/* Credit Cards */}
          <div className="mb-12">
            <h3 className="text-xl font-semibold text-slate-900 mb-6 text-center">Accepted Credit Cards</h3>
          ...
          <div>
            <h3 className="text-xl font-semibold text-slate-900 mb-6 text-center">Financial Service Partners</h3>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <Card className="text-center hover:shadow-lg transition-shadow">
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-slate-600">Community banking partner providing flexible payment solutions</p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center hover:shadow-lg transition-shadow">
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-slate-600">Global payment processing technology for secure transactions</p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center hover:shadow-lg transition-shadow">
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-slate-600">Modern point-of-sale and payment processing solutions</p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center hover:shadow-lg transition-shadow">
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-slate-600">Advanced online payment infrastructure and processing</p>
                </CardContent>
              </Card>
            </div>
          </div>
