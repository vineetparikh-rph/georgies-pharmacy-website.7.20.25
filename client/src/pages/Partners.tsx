...
export default function Partners() {
  ...
  useEffect(() => {
    document.title =
      "Our Partners | Georgies Pharmacy | Local & National Healthcare Partners";
  }, []);
  ...
  const localPartners = [
    ...
    },
    {
      ...
      description:
        "Faith-based healthcare system serving central New Jersey communities.",
      category: "Health System",
      location: "Central NJ",
    ...
    },
    {
      ...
      type: "Health System",
      description:
        "Non-profit health system providing comprehensive care across South Jersey.",
      category: "Health System",
    ...
    },
    {
      ...
      type: "Health Network",
      description:
        "Regional health network serving northern New Jersey and New York areas.",
      category: "Health System",
    ...
    // Major Hospitals
    {
      ...
      description:
        "Full-service medical center serving Union County and surrounding areas.",
      category: "Hospital",
    ...
    },
    {
      ...
      description:
        "Regional academic medical center with advanced specialty services.",
      category: "Hospital",
    ...
    },
    {
      ...
      description:
        "Major teaching hospital providing comprehensive medical services.",
      category: "Hospital",
      location: "Newark, NJ",
    ...
    },
    {
      ...
      type: "Medical Center",
      description:
        "Comprehensive medical center with advanced clinical services.",
      category: "Hospital",
    ...
    // Specialty Hospitals
    {
      ...
      services:
        "Cardiac surgery, pulmonary care, cardiovascular rehabilitation",
    },
    {
      name: "Children's Specialized Hospital",
      type: "Pediatric Hospital",
      description:
        "Leading pediatric rehabilitation hospital serving children with special needs.",
      category: "Specialty",
      location: "Multiple NJ Locations",
    ...
    },
    {
      ...
      type: "Cancer Center",
      description:
        "Comprehensive cancer center providing advanced oncology care.",
      category: "Specialty",
      location: "Multiple NJ Locations",
    ...
    },
    {
      ...
      type: "Specialty Hospital",
      description:
        "Specialized eye care center providing comprehensive ophthalmology services.",
      category: "Specialty",
      location: "Multiple NJ Locations",
    ...
    },
    {
      ...
      description:
        "Army medical facility supporting military training and operations.",
      category: "Military",
    ...
    },
    {
      ...
      description:
        "Full-service VA medical center serving New Jersey veterans.",
      category: "Veterans",
    ...
    },
    {
      ...
      type: "Veterans Hospital",
      description:
        "Specialized VA medical center focusing on extended care services.",
      category: "Veterans",
      location: "Lyons, NJ",
    ...
    },
    {
      ...
      type: "Urgent Care",
      description:
        "Walk-in medical care providing convenient healthcare services.",
      category: "Urgent Care",
      location: "Multiple NJ Locations",
    ...
    },
    {
      ...
      type: "Urgent Care",
      description:
        "National urgent care provider with multiple New Jersey locations.",
      category: "Urgent Care",
      location: "Multiple NJ Locations",
    ...
    },
    {
      ...
      type: "Urgent Care",
      description:
        "Neighborhood urgent care providing quality medical services.",
      category: "Urgent Care",
      location: "Multiple NJ Locations",
    ...
    },
    {
      ...
      type: "Urgent Care",
      description:
        "Modern urgent care centers with advanced medical technology.",
      category: "Urgent Care",
      location: "Multiple NJ Locations",
    ...
    },
    {
      ...
      type: "Urgent Care",
      description:
        "Community-focused urgent care providing accessible healthcare.",
      category: "Urgent Care",
      location: "Multiple NJ Locations",
    ...
    // Medical Groups
    {
      ...
      description:
        "Large multi-specialty medical group serving northern New Jersey.",
    ...
    },
    {
      ...
      type: "Medical Group",
      description:
        "Independent physician group providing comprehensive medical services.",
      category: "Medical Group",
      location: "Multiple NJ Locations",
    ...
    },
    {
      ...
      type: "Medical Practice",
      description:
        "Community-based medical group serving diverse patient populations.",
      category: "Medical Group",
      location: "Multiple NJ Locations",
    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-green-50">
      ...
      <section className="bg-primary text-white py-16">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-primary-foreground/90 max-w-3xl mx-auto">
            Georgies Pharmacy collaborates with leading healthcare organizations
            and pharmaceutical companies to provide you with the highest quality
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-600 max-w-3xl mx-auto">
              We work with Fortune 500 pharmaceutical companies and healthcare
              organizations to ensure reliable medication supply and competitive
              pricing.
            </p>
          </div>
      ...
      <section className="py-16 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-600 max-w-3xl mx-auto">
              Strong relationships with local healthcare providers ensure
              coordinated care and seamless prescription management for our
              community.
            </p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-600 max-w-3xl mx-auto">
              We accept all major credit cards and work with leading financial
              partners to make healthcare accessible and convenient.
            </p>
          </div>
              ...
              <Card className="text-center hover:shadow-lg transition-shadow">
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-slate-600">
                    Community banking partner providing flexible payment
                    solutions
                  </p>
                </CardContent>
              </Card>
      ...
      <section className="py-16 bg-gradient-to-r from-slate-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-slate-900 mb-4">
              Pharmacy Technology Partners
            </h2>
            <p className="text-lg text-slate-600 max-w-3xl mx-auto">
              Powered by industry-leading technology and network partners to
              deliver secure, efficient prescription management and healthcare
              services.
            </p>
          </div>
          ...
          <div className="overflow-hidden relative">
            <div className="flex animate-scroll-left-to-right space-x-6 py-4 whitespace-nowrap">
              ...
              <div className="flex-shrink-0 bg-white rounded-lg p-4 shadow-md border border-slate-200 w-64 h-24 flex items-center justify-center">
                <div className="text-center">
                  <h4 className="font-bold text-indigo-600 text-lg">
                    Vuca Health
                  </h4>
                  <p className="text-xs text-slate-600">
              ...
              <div className="flex-shrink-0 bg-white rounded-lg p-4 shadow-md border border-slate-200 w-64 h-24 flex items-center justify-center">
                <div className="text-center">
                  <h4 className="font-bold text-cyan-600 text-lg">
                    ConnectiveRx
                  </h4>
                  <p className="text-xs text-slate-600">
              ...
              <div className="flex-shrink-0 bg-white rounded-lg p-4 shadow-md border border-slate-200 w-64 h-24 flex items-center justify-center">
                <div className="text-center">
                  <h4 className="font-bold text-violet-600 text-lg">
                    Global Payments
                  </h4>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-slate-600">
                Direct partnerships with major distributors ensure consistent
                medication availability and competitive pricing.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-slate-600">
                Seamless communication with local healthcare providers for
                better patient outcomes and care coordination.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-slate-600">
                Partnerships with accredited organizations ensure the highest
                standards of pharmaceutical care and safety.
              </p>
            </div>
          </div>
        </div>
