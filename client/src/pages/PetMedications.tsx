        ...
        <Card className="bg-white shadow-lg border-0 mb-8 sm:mb-10 lg:mb-12">
          <CardContent className="p-6 sm:p-8 lg:p-12 text-center">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-slate-600 max-w-4xl mx-auto mb-6 sm:mb-8 leading-relaxed">
              At Georgies Pharmacy, we understand that your pets are family.
              That's why we're proud to offer a comprehensive selection of pet
              medications at competitive prices. From prescription treatments to
              preventive care, we're here to help keep your furry friends
              healthy and happy.
            </p>
        ...
        <Card className="bg-gradient-to-r from-primary to-red-900 text-white shadow-lg border-0">
          <CardContent className="p-6 sm:p-8 lg:p-12 text-center">
            ...
            <p className="text-sm sm:text-base lg:text-lg opacity-90 mb-6 sm:mb-8 max-w-2xl mx-auto leading-relaxed">
              Contact us today to discuss your pet's medication needs. Our
              friendly team is here to help ensure your furry family members get
