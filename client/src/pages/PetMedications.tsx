...
const medicationCategories: MedicationCategory[] = [
  {
    ...
    description:
      'Protect your pets from fleas, ticks, and other parasites with our selection of topical and oral treatments.',
  ...
  },
  {
    ...
    description:
      "Keep your pet's heart healthy with effective heartworm preventatives available in various formulations.",
    medications: [
      'Heartgard Plus',
      'Interceptor Plus',
      'Revolution',
  ...
  },
  {
    ...
    description:
      "Prescription medications to treat infections, manage pain, and support your pet's recovery.",
  ...
  },
  {
    ...
    description:
      'Long-term medications for managing diabetes, thyroid conditions, and other chronic health issues.',
    medications: [
      'Insulin (Vetsulin, Novolin)',
      'Levothyroxine',
      'Enalapril',
      'Furosemide',
      'Prednisone',
  ...
  },
  {
    ...
    title: 'Skin & Ear Care',
    description:
      'Topical treatments for skin conditions, ear infections, and dermatological issues.',
  ...
  },
  {
    ...
    description:
      'Nutritional support for joint health, digestive wellness, and overall pet vitality.',
...
const steps: HowItWorksStep[] = [
  {
    ...
    description:
      'Have your veterinarian send the prescription directly to us or bring it in person.',
  },
  {
    number: 2,
    title: "We'll Prepare Your Order",
    description:
      "Our licensed pharmacists will carefully prepare your pet's medication with attention to detail.",
  },
  {
    number: 3,
    title: 'Pick Up or Delivery',
    description:
      'Choose convenient pickup at any of our locations or opt for our free delivery service.',
  },
  {
    number: 4,
    title: 'Ongoing Support',
    description:
      "Our team is always available to answer questions about your pet's medication and care.",
  },
];
...
const benefits: Benefit[] = [
  {
    ...
    description:
      'Competitive pricing on all pet medications with price matching available on most items.',
  },
  {
    icon: <span className="text-2xl">⚡</span>,
    title: 'Fast Turnaround',
    description:
      'Most prescriptions ready within 2-4 hours, with express service available for urgent needs.',
  },
  {
    icon: <span className="text-2xl">🎯</span>,
    title: 'Expert Consultation',
    description:
      'Licensed pharmacists available to answer questions about dosing, side effects, and administration.',
  },
  {
    icon: <span className="text-2xl">🚚</span>,
    title: 'Free Delivery',
    description:
      'Complimentary delivery service to your home for orders over $50 within our service area.',
  },
  {
    icon: <span className="text-2xl">📋</span>,
    title: 'Prescription Management',
    description:
      "Easy refill reminders and automatic refill services to keep your pet's medications current.",
  },
  {
    icon: <span className="text-2xl">🏥</span>,
    title: 'Veterinary Partnership',
    description:
      'Direct coordination with your veterinarian for seamless prescription transfers and updates.',
  },
];
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12">
        ...
        <div className="text-center mb-8 sm:mb-10 lg:mb-12 bg-gradient-to-r from-primary to-red-900 rounded-2xl p-6 sm:p-8 lg:p-12 text-white">
          ...
          <p className="text-base sm:text-lg font-semibold">Best Prices for all pet medications</p>
        </div>
        ...
        <Card className="bg-white shadow-lg border-0 mb-8 sm:mb-10 lg:mb-12">
          <CardContent className="p-6 sm:p-8 lg:p-12 text-center">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-slate-600 max-w-4xl mx-auto mb-6 sm:mb-8 leading-relaxed">
              At Georgies Pharmacy, we understand that your pets are family. That's why we're proud
              to offer a comprehensive selection of pet medications at competitive prices. From
              prescription treatments to preventive care, we're here to help keep your furry friends
              healthy and happy.
            </p>
        ...
        <div className="mb-8 sm:mb-10 lg:mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {medicationCategories.map((category, index) => (
              <Card
                key={index}
                className="bg-white shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border-0 border-t-4 border-t-primary"
              >
                ...
                <CardContent className="pt-0">
                  <ul className="space-y-2">
                    {category.medications.map((medication, idx) => (
                      <li
                        key={idx}
                        className="text-xs sm:text-sm text-slate-700 py-2 border-b border-slate-100 last:border-b-0"
                      >
                        {medication}
                      </li>
                    ))}
        ...
        <Card className="bg-gradient-to-r from-primary to-red-900 text-white shadow-lg border-0">
          <CardContent className="p-6 sm:p-8 lg:p-12 text-center">
            ...
            <p className="text-sm sm:text-base lg:text-lg opacity-90 mb-6 sm:mb-8 max-w-2xl mx-auto leading-relaxed">
              Contact us today to discuss your pet's medication needs. Our friendly team is here to
              help ensure your furry family members get the best care possible.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6 sm:gap-8 lg:gap-12 justify-center items-center">
              <div className="flex items-center gap-3">
                ...
                <a
                  href="tel:+19089254567"
                  className="text-white hover:underline font-semibold text-sm sm:text-base"
                >
                  (908) 925-4567
                </a>
              </div>
