      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-16">
          <h1 className="text-4xl sm:text-5xl font-bold text-slate-900 mb-6">
            HIPAA Notice of{" "}
            <span className="text-primary">Privacy Practices</span>
          </h1>
        ...
        <div className="prose prose-slate max-w-none">
          <div className="bg-white rounded-xl p-8 shadow-sm border border-slate-200 mb-8">
            ...
            <p className="text-slate-600 leading-relaxed">
              Georgies Pharmacy is committed to protecting your health
              information. We are required by law to maintain the privacy of
              your protected health information and to provide you with this
            ...
            <section className="bg-white rounded-xl p-8 shadow-sm border border-slate-200">
              ...
              <div className="space-y-4 text-slate-600">
                <div>
                  ...
                  <p>
                    We may use your health information to provide you with
                    medical treatment or services, including prescription
                    dispensing, medication therapy management, and clinical
                    consultations.
                  </p>
                </div>
                <div>
                  ...
                  <p>
                    ...
                    payment for services we provide to you, including billing
                    your insurance company or other third-party payers.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-slate-900 mb-2">
                  ...
                  <p>
                    ...
                    healthcare operations, including quality assessment,
                    employee review, training of students, licensing, and
              ...
              <div className="space-y-4 text-slate-600">
                <div>
                  ...
                  <p>
                    ...
                    information. To inspect and copy your health information,
                ...
                <div>
                  ...
                  <p>
                    If you feel that your health information is incorrect or
                ...
                <div>
                  ...
                  <p>
                    ...
                    of your health information made by us for certain purposes.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-slate-900 mb-2">
              ...
              <div className="space-y-4 text-slate-600">
                ...
                <div>
                  ...
                  <ul className="list-disc pl-6 space-y-1">
                    ...
                    <li>
                      Proper disposal of documents containing health information
                    </li>
                  </ul>
                </div>
                <div>
                ...
                <div>
                  ...
                  <ul className="list-disc pl-6 space-y-1">
                    ...
                    <li>
                      Assigned privacy officer and security responsibilities
                    </li>
            ...
            <section className="bg-white rounded-xl p-8 shadow-sm border border-slate-200">
              ...
              <div className="text-slate-600">
                <p className="mb-4">
                  ...
                  file a complaint with us or with the Secretary of the
                ...
                <p className="mt-4">
                  <strong>Important:</strong> We will not retaliate against you
