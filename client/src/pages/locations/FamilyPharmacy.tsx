      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          <div>
            ...
            <p className="text-xl text-slate-600 mb-8">
              Our flagship location in Linden, serving families with comprehensive pharmaceutical
              care since our founding. We're your neighborhood pharmacy that truly cares about your
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-slate-600">
                      Free parking available in front of the store and adjacent lot
                    </p>
                  </div>
                  <div>
        ...
        <section className="text-center bg-gradient-to-r from-primary to-red-600 rounded-2xl p-12 text-white">
          ...
          <p className="text-xl text-red-100 mb-8 max-w-2xl mx-auto">
            Join thousands of satisfied families who trust Georgies Family Pharmacy for all their
            medication needs.
          </p>
