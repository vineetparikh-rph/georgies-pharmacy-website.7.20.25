...
export default function GeorgiesFamily() {
  React.useEffect(() => {
    document.title =
      "Georgies Family Pharmacy - Linden, NJ | Full Service Community Pharmacy";
  }, []);

  const handleDirections = () => {
    const address = encodeURIComponent(
      "1201 W St Georges Ave, Linden, NJ 07036",
    );
    window.open(
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-slate-600 mb-6">
            Your neighborhood pharmacy in Linden, NJ
          </p>
          <p className="text-lg text-slate-700 max-w-3xl mx-auto">
            Serving the Linden community since 2011 with personalized care and
            modern convenience. Your health and wellness are our top priorities.
          </p>
        </div>
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg border border-slate-200">
            ...
            <div className="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
              ...
              <p className="text-green-700 text-sm mt-1">
                Call for holiday hours and special appointments
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-slate-600 text-sm">
                  New prescriptions, refills, transfers
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <p className="text-slate-600 text-sm text-center mt-2">
                Licensed PharmD with 15+ years experience
              </p>
            </div>
