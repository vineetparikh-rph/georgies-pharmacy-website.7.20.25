      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-slate-700 max-w-3xl mx-auto">
            Our flagship location offering the full spectrum of pharmacy services including
            specialty medications, clinical services, and comprehensive patient care programs.
          </p>
        </div>
