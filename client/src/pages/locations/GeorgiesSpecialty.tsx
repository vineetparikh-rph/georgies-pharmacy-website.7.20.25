...
export default function GeorgiesSpecialty() {
  React.useEffect(() => {
    document.title =
      "Georgies Specialty Pharmacy - Linden, NJ | Specialized Medication Services";
  }, []);
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-slate-600 mb-6">
            Advanced specialty medication services
          </p>
          <p className="text-lg text-slate-700 max-w-3xl mx-auto">
            Specialized in complex therapies, rare diseases, and high-cost
            medications. Expert care for specialty conditions with comprehensive
            patient support.
          </p>
        </div>
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg border border-slate-200">
            ...
            <div className="mt-6 p-4 bg-purple-50 border border-purple-200 rounded-lg">
              ...
              <p className="text-purple-700 text-sm mt-1">
                Extended consultation hours by appointment
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-slate-600 text-sm">
                  Arthritis and autoimmune treatments
                </p>
              </div>
            </div>
