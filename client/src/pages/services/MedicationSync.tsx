      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto mb-8">
            Simplify your life with our medication synchronization service. Get all your
            prescriptions ready on the same day each month for ultimate convenience.
          </p>
        ...
        <section className="mb-20">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Our medication synchronization program is designed to make managing multiple
              medications easier and more convenient.
            </p>
          </div>
        ...
        <section className="text-center bg-gradient-to-r from-primary to-red-600 rounded-2xl p-12 text-white">
          ...
          <p className="text-xl text-red-100 mb-8 max-w-2xl mx-auto">
            Join hundreds of satisfied patients who have streamlined their medication routine with
            our synchronization service.
          </p>
