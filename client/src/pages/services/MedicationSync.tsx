  ...
  const benefits = [
    {
      ...
      description:
        "All your medications ready on the same convenient day each month",
    },
    {
      icon: <Clock className="h-8 w-8 text-primary" />,
      title: "Time Saving",
      description:
        "Reduce pharmacy visits from multiple trips to just one per month",
    },
    {
      icon: <CheckCircle className="h-8 w-8 text-primary" />,
      title: "Better Adherence",
      description:
        "Never miss doses with organized, synchronized refill schedules",
    },
    {
      icon: <Pill className="h-8 w-8 text-primary" />,
      title: "Medication Management",
      description:
        "Simplified tracking and management of multiple prescriptions",
    },
  ];
  ...
  const howItWorks = [
    {
      ...
      title: "Consultation",
      description:
        "Meet with our pharmacist to review all your current medications",
    },
    {
      step: "2",
      title: "Synchronization",
      description:
        "We align all your prescription refill dates to a single convenient day",
    },
    {
      step: "3",
      title: "Coordination",
      description:
        "Work with your doctors to adjust prescription quantities as needed",
    },
    {
      step: "4",
      title: "Monthly Pickup",
      description:
        "Pick up all medications on your designated sync date each month",
    },
  ];
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto mb-8">
            Simplify your life with our medication synchronization service. Get
            all your prescriptions ready on the same day each month for ultimate
            convenience.
          </p>
        ...
        <section className="mb-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-slate-900 mb-4">
              Why Choose Medication Sync?
            </h2>
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Our medication synchronization program is designed to make
              managing multiple medications easier and more convenient.
            </p>
          </div>
        ...
        <section className="mb-20">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Getting started with medication synchronization is simple and
              straightforward.
            </p>
          </div>
        ...
        <section className="text-center bg-gradient-to-r from-primary to-red-600 rounded-2xl p-12 text-white">
          ...
          <p className="text-xl text-red-100 mb-8 max-w-2xl mx-auto">
            Join hundreds of satisfied patients who have streamlined their
            medication routine with our synchronization service.
          </p>
          ...
          <div className="mt-8 pt-8 border-t border-red-400/30">
            <h3 className="text-lg font-semibold mb-4">
              Available at All Georgies Pharmacy Locations
            </h3>
