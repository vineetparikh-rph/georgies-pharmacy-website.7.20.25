...
export default function Transfers() {
  ...
  React.useEffect(() => {
    document.title =
      "Free Prescription Transfers | Georgies Pharmacy NJ | Transfer Prescriptions";
  }, []);
  return (
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-16 adaptive-spacing">
          ...
          <p className="fluid-text-xl text-slate-600 mb-8 max-w-3xl mx-auto">
            Easily transfer your prescriptions from another pharmacy to Georgies
            Pharmacy. We handle all the paperwork.
          </p>
        </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-slate-600">
                    Share your current pharmacy details, prescription numbers,
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-slate-600">
                    Our team contacts your current pharmacy to initiate the
                    transfer process.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-slate-600">
                    We handle all necessary paperwork and obtain approvals from
                    your previous pharmacy.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-slate-600">
                    Your transferred prescription is filled and ready for pickup
                    at Georgies Pharmacy.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="text-center bg-gradient-to-r from-secondary to-green-600 rounded-2xl p-12 text-white">
          <h2 className="text-3xl font-bold mb-4">
            Ready to Transfer Your Prescriptions?
          </h2>
          <p className="text-xl text-green-100 mb-8">
            Start your transfer request today and experience better pharmacy
            care.
          </p>
          <Button
            onClick={() =>
