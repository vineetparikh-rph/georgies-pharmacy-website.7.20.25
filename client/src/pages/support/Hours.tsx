          ...
          <Card>
            <CardContent className="pt-6">
              <p className="text-slate-600 mb-4">
                Our pharmacy hours may vary during holidays. Please call your local Georgies
                Pharmacy location or check our website for holiday-specific hours.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="text-slate-600">
                    Modified hours may apply on Thanksgiving, Memorial Day, Independence Day, and
                    Labor Day
                  </p>
                </div>
              </div>
