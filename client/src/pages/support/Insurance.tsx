      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-600 mb-8">
            We accept most major insurance plans to make your prescriptions affordable and
            accessible.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card>
              ...
              <CardContent>
                <div className="space-y-3 text-slate-600">
                  <p>
                    We verify your insurance coverage before filling prescriptions to ensure
                    accurate pricing.
                  </p>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-3 text-slate-600">
                  <p>
                    Our team handles all insurance claims processing efficiently and accurately.
                  </p>
                  <ul className="list-disc pl-6 space-y-1 text-sm">
            ...
            <CardContent>
              <div className="space-y-4 text-blue-800">
                <div>
                  ...
                  <p>
                    We participate in most Medicare Part D prescription drug plans. Our pharmacists
                    can help you understand your coverage and find cost-effective options.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">Medicare Advantage</h4>
                  <p>
                    We work with Medicare Advantage plans to ensure you receive the benefits you're
                    entitled to, including any additional prescription coverage.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">Annual Enrollment</h4>
                  <p>
                    Our team can provide guidance during Medicare open enrollment periods to help
                    you choose the best plan for your medication needs.
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent>
              <div className="space-y-4 text-green-800">
                <div>
                  ...
                  <p>
                    We accept New Jersey Medicaid and most Medicaid managed care plans. Bring your
                    Medicaid card and photo ID for prescription pickup.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">Medicaid Managed Care</h4>
                  <p>
                    We work with Medicaid managed care organizations including AmeriHealth, Horizon
                    NJ Health, and UnitedHealthcare Community Plan.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">Prior Authorizations</h4>
                  <p>
                    Our clinical team assists with Medicaid prior authorization requests to ensure
                    timely access to your medications.
                  </p>
                </div>
              </div>
            </CardContent>
        ...
        <section className="text-center bg-gradient-to-r from-primary to-red-600 rounded-2xl p-12 text-white">
          ...
          <p className="text-xl text-red-100 mb-8">
            Our insurance specialists are here to help you understand your coverage and maximize
            your benefits.
          </p>
